...
export interface DataDestinationSalesforceHopContent {
  nodeType: 'data-destination-salesforce-hop'
  object: string
  statement: string
}

export const dataDestinationSalesforceHopDefaultContent: DataDestinationSalesforceHopContent = {
  nodeType: 'data-destination-salesforce-hop',
  object: '',
  statement: '',
}

export const DataDestinationSalesforceHop = ({
  data,
  noHandle,
  yPos,
}: {
  ...
  const [nodeContent, setNodeContent] = useState<DataDestinationSalesforceHopContent>(
    dataDestinationSalesforceHopDefaultContent,
  )
  const [nodeFormContent, setNodeFormContent] = useState<DataDestinationSalesforceHopContent>(
    dataDestinationSalesforceHopDefaultContent,
  )
  ...
  // Initial data
  useEffect(() => {
    if (data.initialContents.nodeType === 'data-destination-salesforce-hop') {
      ...
      <div className="w-[400px] rounded-md border border-slate-300 bg-white p-3 shadow-md">
        <div className="flex items-center gap-4">
          <div className="flex w-10 items-center justify-center">
            <SiSalesforce size={40} className="text-slate-600" />
          </div>
          <div>
            ...
            <div className="text-lg font-medium">Export data to Salesforce</div>
          </div>
                          ...
                          <div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                            ...
                            <div className="sm:col-span-2">
                              <textarea
                                ...
                                value={nodeFormContent.statement}
                                onChange={e => {
                                  const newText = e.target.value
                                  ...
                                  setNodeFormContent(prev => {
                                    const newFormContent = cloneDeep(prev)
                                    newFormContent.statement = newText
                                    return newFormContent
                                  })
                                }}
                              />
