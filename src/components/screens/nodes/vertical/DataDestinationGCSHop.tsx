...
export interface DataDestinationGCSHopContent {
  nodeType: 'data-destination-gcs-hop'
...
export const dataDestinationGCSHopDefaultContent: DataDestinationGCSHopContent = {
  nodeType: 'data-destination-gcs-hop',
  bucket: '',
  path: '',
  importedKeys: {},
...
export const DataDestinationGCSHop = ({
  data,
  noHandle,
}: {
  data: NodeData
  ...
  const [nodeContent, setNodeContent] = useState<DataDestinationGCSHopContent>(
    dataDestinationGCSHopDefaultContent,
  )
  const [nodeFormContent, setNodeFormContent] = useState<DataDestinationGCSHopContent>(
    dataDestinationGCSHopDefaultContent,
  )

  // Initial data
  useEffect(() => {
    if (data.initialContents.nodeType === 'data-destination-gcs-hop') {
      ...
      <div className="w-[400px] rounded-md border border-slate-300 bg-white p-3 shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-lg font-medium">Store data in Google Cloud Storage</div>
          </div>
