...
export const DataSourceS3Hop = ({
  ...
  const { nodeContent, setNodeContent } = useNodeContent<DataSourceS3HopContent>({
    nodeId: data.nodeId,
    defaultContent: dataSourceS3HopDefaultContent,
                              ...
                              <Select
                                ...
                                onChange={e => {
                                  const newVal = e.target
                                    .value as DataSourceS3HopContent['fileType']
                                ...
                                <option value={'csv' satisfies DataSourceS3HopContent['fileType']}>
                                  csv
                                </option>
                                <option value={'mp3' satisfies DataSourceS3HopContent['fileType']}>
                                  mp3
                                </option>
                                <option value={'pdf' satisfies DataSourceS3HopContent['fileType']}>
                                  pdf
                                </option>
                                <option value={'txt' satisfies DataSourceS3HopContent['fileType']}>
                                  txt
                                </option>
                              </Select>
                            </div>
