...
export interface DataDestinationAzureHopContent {
  nodeType: 'data-destination-azure-hop'
  bucket: string
  path: string
  importedKeys: Record<string, boolean>
}

export const dataDestinationAzureHopDefaultContent: DataDestinationAzureHopContent = {
  nodeType: 'data-destination-azure-hop',
  bucket: '',
  path: '',
  importedKeys: {},
...
export const DataDestinationAzureHop = ({
  data,
  noHandle,
  yPos,
}: {
  ...
  const [nodeContent, setNodeContent] = useState<DataDestinationAzureHopContent>(
    dataDestinationAzureHopDefaultContent,
  )
  const [nodeFormContent, setNodeFormContent] = useState<DataDestinationAzureHopContent>(
    dataDestinationAzureHopDefaultContent,
  )
  ...
  // Initial data
  useEffect(() => {
    if (data.initialContents.nodeType === 'data-destination-azure-hop') {
      ...
      <div className="w-[400px] rounded-md border border-slate-300 bg-white p-3 shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-lg font-medium">Store data in Azure Blob Storage</div>
          </div>
