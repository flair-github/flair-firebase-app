...
export const DataSourceMongoHop = ({
  data,
  noHandle,
  yPos,
}: {
  ...
  const { nodeContent, setNodeContent } = useNodeContent<DataSourceMongoHopContent>({
    nodeId: data.nodeId,
    defaultContent: dataSourceMongoHopDefaultContent,
