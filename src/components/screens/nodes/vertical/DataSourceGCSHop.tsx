                              ...
                              <Select
                                ...
                                onChange={e => {
                                  const newVal = e.target
                                    .value as DataSourceGCSHopContent['fileType']
                                ...
                                <option value={'csv' satisfies DataSourceGCSHopContent['fileType']}>
                                  csv
                                </option>
                                <option value={'mp3' satisfies DataSourceGCSHopContent['fileType']}>
                                  mp3
                                </option>
                                <option value={'pdf' satisfies DataSourceGCSHopContent['fileType']}>
                                  pdf
                                </option>
                                <option value={'txt' satisfies DataSourceGCSHopContent['fileType']}>
                                  txt
                                </option>
                              </Select>
                            </div>
