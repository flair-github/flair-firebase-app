...
function Credentials() {
  const [isAddCredentialModalShown, setIsAddCredentialModalShown] = useState(false)
  ...
  return (
    <>
              ...
              <div className="border-gray-200 bg-white px-4 py-5 sm:px-6">
                <div className="-ml-4 -mt-2 mb-5 flex flex-wrap items-center justify-between border-b pb-5 sm:flex-nowrap">
                  <div className="ml-4 mt-2 shrink-0">
                    <button
                      onClick={() => {
                        setIsAddCredentialModalShown(true)
                      }}
                      type="button"
      ...
      <Modal
        shown={isAddCredentialModalShown}
        onClickBackdrop={() => {
          setIsAddCredentialModalShown(false)
        }}>
        <div className="text-lg font-medium">Select a service to add</div>
        <div className="my-3 flex flex-wrap items-center gap-2">
          {[
            {
              service: 'AWS',
              img: '/images/data-sources/s3.svg',
            },
            {
              service: 'GCP',
              img: '/images/data-sources/gcp.svg',
            },
            {
              service: 'Postgres',
              img: '/images/data-sources/postgres.svg',
            },
            {
              service: 'Azure',
              img: '/images/data-sources/azure.svg',
            },
            {
              service: 'Google',
              img: '/images/data-sources/google.svg',
            },
            {
              service: 'Open AI',
              img: '/images/data-sources/open-ai.svg',
            },
            {
              service: 'Twilio',
              img: '/images/data-sources/twilio.svg',
            },
          ].map(el => (
            <div className="flex w-32 shrink-0 flex-col items-center rounded-md border px-5 py-3">
              <img src={el.img} width={75} height={75} className="p-1" />
              <div className="text-center">{el.service}</div>
            </div>
          ))}
        </div>
      </Modal>
